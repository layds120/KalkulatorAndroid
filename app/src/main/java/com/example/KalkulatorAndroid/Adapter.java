...
public class Adapter extends RecyclerView.Adapter<com.example.KalkulatorAndroid.Adapter.MyViewHolder> {
    private Context Ctx;
        ...
        holder.Hapus.setOnClickListener(v ->
                ...
                db.collection("data_hitung").document(prosesHitung.getID())
                        ...
                        .addOnSuccessListener(aVoid -> {
                            Intent intent = new Intent(Ctx, com.example.KalkulatorAndroid.MainActivity.class);
